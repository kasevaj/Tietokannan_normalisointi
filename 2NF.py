...
# EläinToimenpiteet: primary = Eläin + toimenpide + toimenpiteen pvm, hoitajan nimi
df_toimenpiteet = df[["EläinID", "Toimenpide", "Toimenpiteen pvm", "HoitajaID"]].drop_duplicates()
